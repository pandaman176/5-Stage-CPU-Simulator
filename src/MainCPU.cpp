...
int main(int argc, char **argv) {
  ...
  simulator.isDataForward = isDataForward;
      ...
      case 'b':
        if (i + 1 < argc) {
          ...
          if (str == "AT") {
            ...
            strategy = BranchPredictor::Strategy::CBP32;
          } else if (str == "CBP16") {
            strategy = BranchPredictor::Strategy::CBP16;
          } else if (str == "CBP8") {
            strategy = BranchPredictor::Strategy::CBP8;
          } else if (str == "CBP4") {
            strategy = BranchPredictor::Strategy::CBP4;
          } else {
            return false;
          }
        } else {
